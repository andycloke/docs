...
**Note:** You can also manage variables through the main settings screen by clicking the settings icon (⚙️) in the Data Fetcher extension and navigating to your workspace settings.
