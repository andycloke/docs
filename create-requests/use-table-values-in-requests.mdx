...
When running on multiple records, you may want the request to continue running through errors. You can enable this by selecting **Continue through errors** under Error Handling.
