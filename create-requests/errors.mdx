...
You have a [linked field in the response field mapping](https://help.datafetcher.com/create-requests/response-field-mapping#linked-records-in-response-field-mapping) and Data Fetcher needs to create records in the linked table (in order to link to them) but is not able to. This typically happens for two different reasons:
...
- Open the [response field mapping](https://help.datafetcher.com/create-requests/response-field-mapping) and find the response field.
- Click the field settings icon .
- Disable the [Create missing records](https://help.datafetcher.com/create-requests/response-field-mapping#create-missing-linked-records) option.
...
Your request uses a variable but this variable no longer exists in your Data Fetcher workspace.  You need to [create the variable](https://help.datafetcher.com/create-requests/use-variables-in-requests#create-a-variable) again in your workspace or update the request to not use this variable.
...
- [Open the response field mapping](https://help.datafetcher.com/create-requests/response-field-mapping).
...
Your Data Fetcher workspace needs to be authorized to access all the bases where you want to use scheduled/ trigger/ webhook URLs runs. You either need to turn off the failing request's scheduled/trigger/webhook URL or [re-authenticate Data Fetcher and Airtable](https://help.datafetcher.com/account/authorize-data-fetcher-airtable).
