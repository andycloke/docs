...
9. Once you're satisfied with the response field mapping, click **Save & Run** in the bottom right corner.
...
<CardGroup cols={2}>
  ...
  <Card title="Add trigger" icon="zap" href="/create-requests/add-a-request-trigger">
    Run requests instantly when your base data changes
  </Card>
  <Card title="Write modes" icon="plus" href="/advanced-options/write-modes">
    Learn how to update or add to existing records
  </Card>
  <Card title="Update based on field(s)" icon="hashtag" href="/advanced-options/update-based-on-field">
