...
1. Make sure all requests in your sequence use the same **input table**.
...
3. Paste the following code into the script, replacing `YOUR_WEBHOOK_URL` with your sequence's webhook URL:

```
await fetch(`YOUR_WEBHOOK_URL`);
```

![Webhook URL script automation](/images/webhookurlscriptautomation.jpeg)
