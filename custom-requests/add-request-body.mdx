...
2. Enter your JSON data into the input field. You can validate your JSON using [this tool](https://jsonlint.com).
...
1. Click the **XML** tab.
2. Enter your XML content in the input field. You can validate your XML using [this tool](https://www.xmlvalidation.com).
