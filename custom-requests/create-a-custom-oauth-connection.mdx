...
- Data Fetcher does not have a [preset OAuth connection](https://help.datafetcher.com/custom-requests/connect-to-a-preset-oauth-api) for that specific API.
...
1. [Create a custom request](https://help.datafetcher.com/custom-requests/create-a-custom-request) in Data Fetcher.
