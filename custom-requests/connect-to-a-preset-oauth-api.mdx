...
If you don't see the OAuth API you want to connect to in the list of preset options, you can [create a custom OAuth connection](/custom-requests/create-a-custom-oauth-connection).