...
4. Use the **\+** icon next to the value field to [use table values from your Airtable base](https://help.datafetcher.com/create-requests/use-table-values-in-requests) into the header.
