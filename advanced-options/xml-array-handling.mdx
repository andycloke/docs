...
2. This object is then converted into tabular data (fields and records) using the standard [response data transformation](/advanced-options/response-data-transformations).
...
<video
  ...
  src="/videos/Xml array handling.mp4"
></video>
