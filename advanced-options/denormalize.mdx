...
For example, calling the [exchangerate.host](http://exchangerate.host) API between `2020-01-01` and `2020-01-03` gives us this JSON:
...
When mapping this [response using field mapping](https://help.datafetcher.com/create-requests/response-field-mapping), we get a different field name for each date key under `rates`. For example, `rates.2020-01-01.USD` and `rates.2020-01-02.USD` would be treated as separate fields.
