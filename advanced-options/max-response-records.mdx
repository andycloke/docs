...
3. When you run the request, the [Response field mapping](https://help.datafetcher.com/create-requests/response-field-mapping) will refresh with the Max response records setting applied.

<Info>
  These settings are also available on the [Response Field Mapping](https://help.datafetcher.com/create-requests/response-field-mapping#access-advanced-settings).
</Info>