...
When no output mode is enabled, the destination table / view selection, response field mapping, and data transformation options are hidden since they are not needed.
