...
3. Enter the **Cursor variable** name.
4. Select the **Cursor field** from the dropdown. Typically, this is an ID field or a pagination cursor field in the response.
