...
1. Select the **Cursor field** from the dropdown. Typically, this is an ID field or a pagination cursor field in the response.
   1. You can optionally enter a **Page size variable** or just a **Page size** value. This will help Data Fetcher know when to stop paginating if you have selected the **Fetch all pages** option.Pa