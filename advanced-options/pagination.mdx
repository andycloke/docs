...
1. [Set the pagination type](https://help.datafetcher.com/advanced-options/pagination#select-pagination-type) to "Offset Body".
2. Set the **number of pages** to fetch or select **Fetch all pages.**
...
1. [Set the pagination type](https://help.datafetcher.com/advanced-options/pagination#select-pagination-type) to "Header".
2. Set the **number of pages** to fetch or select **Fetch all pages.**
...
3. [Set the pagination type](https://help.datafetcher.com/advanced-options/pagination#select-pagination-type) to "GraphQL Cursor".
