...
<Note>
  You can [copy the response JSON](/create-requests/response-field-mapping#working-with-response-data) and test your JMESPath expressions on the [official JMESPath website](https://jmespath.org/) before adding them to Data Fetcher.
</Note>
