...
1. [**Create and save a request**](https://help.datafetcher.com/create-requests/create-a-request) in Data Fetcher. You can close the extension dashboard afterward, but remain logged into Data Fetcher.
...
You can assign different requests (and [sequences](https://help.datafetcher.com/create-sequences/create-a-sequence)) to button fields across different tables or views within the same table.
...
When working with requests that [run on multiple records](https://help.datafetcher.com/create-requests/use-table-values-in-requests#run-on-multiple-records), button fields offer two execution options:
